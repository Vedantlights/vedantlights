        ...
        <div class="card">
         ...
         <div class="col-lg-6 col-md-6 col-sm-6">
          ...
          <div class="body">
            ...
            <form action="<?php echo base_url(); ?>addCategorydetails" method="POST" enctype="multipart/form-data">
              ...
              <table class="table table-bordered table-hover dataTable js-exportable">
                ...
                <tbody>
                  ...
                  <?php
                    ...
                    foreach($categoryDetails as $val){
                  ...
                  <tr>
                    ...
                    <td><?php echo $val["caterogyName"]; ?></td>
                     ...
                     <td>
                      ...
                      <div class="dt-buttons btn-group"><a href="<?php echo base_url(); ?>editcategory/<?php echo base64_encode($val["cat_id"]); ?>"><button type="button" class="btn btn-success btn-icon-only"><span class="btn-inner--icon"><i class="fa fa-pencil-square-o"></i></span></button></a>&nbsp;&nbsp; | &nbsp;&nbsp; <a href="<?php echo base_url(); ?>Category/deletecategory/<?php echo base64_encode($val["cat_id"]); ?>"><button type="button" class="btn btn-danger btn-icon-only"><span class="btn-inner--icon"><i class="fa fa-trash-o"></i></span></button></a></div>
